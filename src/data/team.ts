  ...
  return {
    ...
    timeline: opts.timeline ?? (() => {
      ...
      if (opts.generation === "14") {
        return [
          { year: "2026-27", label: `Technical Coordinator (${vert})` }
        ];
      } else if (opts.generation === "13") {
        return [
          { year: "2025-26", label: `Technical Coordinator (${vert})` },
          { year: "2026-27", label: opts.position }
        ];
      } else if (opts.generation === "12") {
        return [
          { year: "2024-25", label: `Technical Coordinator (${vert})` },
          { year: "2025-26", label: opts.position },
          { year: "2026-27", label: "Senior Advisor" }
        ];
      }
      return [
...
export const leadership: Member[] = [
  ...
  makeMember({
    ...
    achievements: ["Vehicle Design Head in 2026-27"],
    social: {
  ...
  makeMember({
    ...
    isCurrent: true,
    isLeadership: true,
    bio: "Designed dual motor control PCB and its control logic, serving as Embedded Systems Head in 2026-27.",
    skills: [],
...
const gen2026 = [
  ...
  },
  {
    ...
    position: "Embedded Systems Member",
    department: "Electronics Engineering" as Department,
    team: "Electronics" as TeamGroup,
    social: {
  ...
  },
  {
    ...
    photo: "/assets/team/abhinav_dwivedi.webp",
    bio: "Working in the Chassis subsystem under Vehicle Design.",
    achievements: [],
    skills: [],
    position: "Technical Coordinator (Chassis)",
    department: "Mechanical Engineering" as Department,
    team: "Mechanical" as TeamGroup,
    social: {
      email: "abhinav.dwivedi.mec25@itbhu.ac.in",
      phone: "9621799942",
    },
  },
  {
    name: "Reva Jalan",
    photo: "/assets/team/reva_jalan.webp",
    bio: "Working on aerodynamic simulations and design optimization.",
    achievements: [],
    skills: [],
    position: "Technical Coordinator (Aerodynamics)",
    department: "Mechanical Engineering" as Department,
    team: "Mechanical" as TeamGroup,
    social: {
      linkedin: "https://www.linkedin.com/in/reva-jalan-12801236b",
      email: "reva.jalan.mec25@itbhu.ac.in",
      phone: "7396980051",
    },
  },
  {
    name: "Prateek Kumar Gupta",
    photo: "/assets/team/prateek_kumar_gupta.webp",
    bio: "Working on chassis structural modeling and testing.",
    achievements: [],
    skills: [],
    position: "Technical Coordinator (Chassis)",
    department: "Mechanical Engineering" as Department,
    team: "Mechanical" as TeamGroup,
    social: {
      linkedin: "https://www.linkedin.com/in/prateek-kumar-gupta-5a04433aa",
      email: "prateek.gupta2503@gmail.com",
      phone: "7300399764",
    },
  },
];
...
const gen2025 = [
  ...
  },
  {
    ...
    position: "Vehicle Design Engineer (Braking System)",
    department: "Mechanical Engineering" as Department,
    team: "Mechanical" as TeamGroup,
  ...
  },
  {
    ...
    position: "Vehicle Design Engineer (Suspension)",
    department: "Mechanical Engineering" as Department,
    team: "Mechanical" as TeamGroup,
  ...
  },
  {
    ...
    position: "RoS Engineer (Autonomy)",
    department: "Mechanical Engineering" as Department,
    team: "Technical" as TeamGroup,
  ...
  },
  {
    ...
    position: "Vehicle Design Engineer (Aerodynamics)",
    department: "Mechanical Engineering" as Department,
    team: "Mechanical" as TeamGroup,
    bio: "Worked on design and aerodynamic analysis of outerbody of car",
    achievements: [],
  ...
  },
  {
    ...
    position: "Perception Engineer (Autonomy)",
    department: "Civil Engineering" as Department,
    team: "Technical" as TeamGroup,
  ...
  {
    name: "Madhvendra Pratap",
    photo: "/assets/team/madhvendra_pratap.webp",
    position: "Vehicle Design Engineer (Steering System)",
    department: "Mechanical Engineering" as Department,
    team: "Mechanical" as TeamGroup,
    bio: "Worked on steering vertical and design coordinator in 2025-26.",
    achievements: [],
    skills: [],
    social: {
      linkedin: "https://www.linkedin.com/in/madhvendra-pratap-794137314",
      email: "madhvendrapratap.iitbhu@gmail.com",
      phone: "6392716699",
    },
  },
  {
...
const gen2024 = [
  ...
  },
  {
    ...
    achievements: ["Vehicle Design Head in 2025-26"],
    skills: [],
    social: {
  ...
  },
  {
    ...
    position: "Project Manager (Urban Concept Vehicle)",
    department: "Electronics Engineering" as Department,
    team: "Electronics" as TeamGroup,
    bio: "Designed dual motor control PCB and its control logic, served as Project Manager in 2025-26.",
    achievements: ["Project Manager in 2025-26"],
    skills: [],
    social: {
  ...
  },
  {
    ...
    department: "Electronics Engineering" as Department,
    team: "Electronics" as TeamGroup,
    bio: "Worked on DNT, dual motor control PCB, served as Embedded Systems Head in 2025-26.",
    achievements: ["Embedded Systems Head in 2025-26"],
    skills: [],
    social: {
  ...
  "11": [
    {
      ...
      department: "Mechanical Engineering",
      team: "Management",
      photo: "/src/assets/alumni/gen 11/Gyanaranjan.webp",
    ...
    },
    {
      ...
      team: "Technical",
      photo: "/src/assets/alumni/gen 11/Shashwat.webp",
    ...
    },
    {
      ...
      department: "Mechanical Engineering",
      team: "Mechanical",
      photo: "/src/assets/alumni/gen 11/ratnam.webp",
    ...
    },
    {
      ...
      department: "Electronics Engineering",
      team: "Electronics",
      photo: "/src/assets/alumni/gen 11/Anirudh.webp",
    ...
    },
    {
      ...
      department: "Mechanical Engineering",
      team: "Mechanical",
      photo: "/src/assets/alumni/gen 11/Sharad.webp",
    ...
    },
    {
      ...
      team: "Design",
      photo: "/src/assets/alumni/gen 11/Bhavya.webp",
  ...
  "10": [
    {
      ...
      department: "Computer Science",
      team: "Technical",
      photo: "/src/assets/alumni/gen 10/Darshan.webp",
    ...
    },
    {
      ...
      department: "Mechanical Engineering",
      team: "Mechanical",
      photo: "/src/assets/alumni/gen 10/Sugavanesh Photo.webp",
    ...
    },
    {
      ...
      department: "Electronics Engineering",
      team: "Electronics",
      photo: "/src/assets/alumni/gen 10/Mithilesh.webp",
    ...
    },
    {
      ...
      department: "Mechanical Engineering",
      team: "Mechanical",
      photo: "/src/assets/alumni/gen 10/Yash.webp",
  ...
  "9": [
    {
      ...
      department: "Industrial Design",
      team: "Management",
      photo: "/src/assets/alumni/gen 9/ASTITVA_edited.webp",
    ...
    },
    {
      ...
      department: "Computer Science",
      team: "Technical",
      photo: "/src/assets/alumni/gen 9/jaynil.webp",
    ...
    },
    {
      ...
      department: "Electronics Engineering",
      team: "Electronics",
      photo: "/src/assets/alumni/gen 9/Naitik.webp",
    ...
    },
    {
      ...
      team: "Research",
      photo: "/src/assets/alumni/gen 9/prateek.webp",
    ...
    },
    {
      ...
      department: "Mechanical Engineering",
      team: "Mechanical",
      photo: "/src/assets/alumni/gen 9/pratmesh.webp",
    ...
    },
    {
      ...
      department: "Computer Science",
      team: "Technical",
      photo: "/src/assets/alumni/gen 9/shubh.webp",
    ...
    },
    {
      ...
      department: "Mechanical Engineering",
      team: "Mechanical",
      photo: "/src/assets/alumni/gen 9/Yash_edited.webp",
  ...
  "8": [
    {
      ...
      department: "Computer Science",
      team: "Technical",
      photo: "/src/assets/alumni/gen 8/Atharva.webp",
    ...
    },
    {
      ...
      department: "Mechanical Engineering",
      team: "Management",
      photo: "/src/assets/alumni/gen 8/Rahul.webp",
    ...
    },
    {
      ...
      department: "Electronics Engineering",
      team: "Electronics",
      photo: "/src/assets/alumni/gen 8/Harsh.webp",
    ...
    },
    {
      ...
      department: "Pharmaceutical Engineering",
      team: "Research",
      photo: "/src/assets/alumni/gen 8/Aman.webp",
    ...
    },
    {
      ...
      department: "Mechanical Engineering",
      team: "Mechanical",
      photo: "/src/assets/alumni/gen 8/Prateek.webp",
    ...
    },
    {
      ...
      department: "Electronics Engineering",
      team: "Electronics",
      photo: "/src/assets/alumni/gen 8/Shreyansh.webp",
  ...
  "7": [
    {
      ...
      department: "Mechanical Engineering",
      team: "Mechanical",
      photo: "/src/assets/alumni/gen 7/Tejas Chavan.webp",
    ...
    },
    {
      ...
      department: "Industrial Design",
      team: "Management",
      photo: "/src/assets/alumni/gen 7/Sweekar Banthiya.webp",
    ...
    },
    {
      ...
      department: "Mechanical Engineering",
      team: "Mechanical",
      photo: "/src/assets/alumni/gen 7/Sushrut Mirzapure.webp",
    ...
    },
    {
      ...
      department: "Computer Science",
      team: "Technical",
      photo: "/src/assets/alumni/gen 7/Shashank Maddeshiya.webp",
    ...
    },
    {
      ...
      department: "Electronics Engineering",
      team: "Electronics",
      photo: "/src/assets/alumni/gen 7/Rohan Nemade.webp",
    ...
    },
    {
      ...
      department: "Pharmaceutical Engineering",
      team: "Research",
      photo: "/src/assets/alumni/gen 7/Vikas Goyat.webp",
  ...
  "6": [
    {
      ...
      department: "Mechanical Engineering",
      team: "Mechanical",
      photo: "/src/assets/alumni/gen 6/Shubham Yadav.webp",
    ...
    },
    {
      ...
      department: "Electronics Engineering",
      team: "Electronics",
      photo: "/src/assets/alumni/gen 6/Snehal.webp",
    ...
    },
    {
      ...
      department: "Computer Science",
      team: "Technical",
      photo: "/src/assets/alumni/gen 6/Shashank Kumar.webp",
    ...
    },
    {
      ...
      department: "Pharmaceutical Engineering",
      team: "Research",
      photo: "/src/assets/alumni/gen 6/Rishabh Singh.webp",
    ...
    },
    {
      ...
      department: "Computer Science",
      team: "Technical",
      photo: "/src/assets/alumni/gen 6/Abhay Agrawal.webp",
  ...
  "5": [
    {
      ...
      department: "Mechanical Engineering",
      team: "Mechanical",
      photo: "/src/assets/alumni/gen 5/Saurabh20Patel.webp",
    ...
    },
    {
      ...
      team: "Electronics",
      photo: "/src/assets/alumni/gen 5/Himanshu20Sahu.webp",
    ...
    },
    {
      ...
      department: "Computer Science",
      team: "Technical",
      photo: "/src/assets/alumni/gen 5/Rayala20Kartheek.webp",
      bio: "Maintained safety nodes, autonomous telemetry dashboards, and live tracking APIs.",
    ...
    },
    {
      ...
      department: "Pharmaceutical Engineering",
      team: "Research",
      photo: "/src/assets/alumni/gen 5/hriddhighosh.webp",
    ...
    },
    {
      ...
      department: "Industrial Design",
      team: "Design",
      photo: "/src/assets/alumni/gen 5/Abhyuday20Verma.webp",
  ...
  "4": [
    {
      ...
      department: "Mechanical Engineering",
      team: "Mechanical",
      photo: "/src/assets/alumni/gen 4/Lakshya Bhonde.webp",
    ...
    },
    {
      ...
      department: "Computer Science",
      team: "Technical",
      photo: "/src/assets/alumni/gen 4/Rishav Guha.webp",
    ...
    },
    {
      ...
      department: "Electronics Engineering",
      team: "Electronics",
      photo: "/src/assets/alumni/gen 4/Shivam20Formal_JPG.webp",
    ...
    },
    {
      ...
      department: "Mechanical Engineering",
      team: "Mechanical",
      photo: "/src/assets/alumni/gen 4/Pawas Suman.webp",
    ...
    },
    {
      ...
      department: "Industrial Design",
      team: "Design",
      photo: "/src/assets/alumni/gen 4/Somesh Jaiswal.webp",
  ...
  "3": [
    {
      ...
      department: "Mechanical Engineering",
      team: "Mechanical",
      photo: "/src/assets/alumni/gen 3/Aditya Raghuwanshi.webp",
    ...
    },
    {
      ...
      department: "Computer Science",
      team: "Technical",
      photo: "/src/assets/alumni/gen 3/Rajat Singhvi.webp",
    ...
    },
    {
      ...
      department: "Electronics Engineering",
      team: "Electronics",
      photo: "/src/assets/alumni/gen 3/Aniket Sahoo.webp",
    ...
    },
    {
      ...
      department: "Pharmaceutical Engineering",
      team: "Research",
      photo: "/src/assets/alumni/gen 3/Shashank More.webp",
    ...
    },
    {
      ...
      department: "Mechanical Engineering",
      team: "Mechanical",
      photo: "/src/assets/alumni/gen 3/Anitya Gutpa.webp",
    ...
    },
    {
      ...
      department: "Industrial Design",
      team: "Design",
      photo: "/src/assets/alumni/gen 3/Akash Chaurasia.webp",
  ...
  "2": [
    {
      ...
      department: "Mechanical Engineering",
      team: "Mechanical",
      photo: "/src/assets/alumni/gen 2/Akash Gupta.webp",
    ...
    },
    {
      ...
      department: "Electronics Engineering",
      team: "Electronics",
      photo: "/src/assets/alumni/gen 2/Ankit patel.webp",
  ...
  "1": [
    {
      ...
      department: "Mechanical Engineering",
      team: "Management",
      photo: "/src/assets/alumni/founders/kanishk(1).webp",
    ...
    },
    {
      ...
      department: "Computer Science",
      team: "Technical",
      photo: "/src/assets/alumni/founders/ankit verma.webp",
    ...
    },
    {
      ...
      department: "Industrial Design",
      team: "Design",
      photo: "/src/assets/alumni/founders/Aditya Saraswat.webp",
    ...
    },
    {
      ...
      department: "Mechanical Engineering",
      team: "Mechanical",
      photo: "/src/assets/alumni/founders/Ranjeet Kumar.webp",
    ...
    },
    {
      ...
      department: "Electrical Engineering",
      team: "Electronics",
      photo: "/src/assets/alumni/founders/manishankarmeena.webp",
    ...
    },
    {
      ...
      department: "Mechanical Engineering",
      team: "Mechanical",
      photo: "/src/assets/alumni/founders/Vivek  Chauhan.webp",
