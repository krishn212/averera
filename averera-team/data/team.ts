...
export const leadership: Member[] = [
  makeMember({
    ...
    isCurrent: true,
    isLeadership: true,
    bio: "Leads overall team operations, coordination, outreach campaigns, and structural resource allocations for Team Averera.",
    skills: ["Team Leadership", "Operations", "Project Execution", "Branding"],
    social: {
  ...
  makeMember({
    ...
    isCurrent: true,
    isLeadership: true,
    bio: "Manages engineering timelines, coordinates safety milestones, and schedules integration deadlines for the Urban Concept EV platform.",
    skills: ["Project Management", "Automotive Systems", "Agile Execution"],
    social: {
  ...
  makeMember({
    ...
    isCurrent: true,
    isLeadership: true,
    bio: "Leads mechanical systems integration, structural optimization, chassis layout iterations, and aerodynamic testing validation.",
    skills: ["SolidWorks", "ANSYS Structural", "Aerodynamics Analysis", "GD&T"],
    projects: ["Alterno Shell Design Redesign", "Chassis Structural Testing"],
    achievements: ["Successfully optimized chassis weight targets by 10%"],
    social: {
  ...
  makeMember({
    ...
    isCurrent: true,
    isLeadership: true,
    bio: "Leads structural and mechanical design validation, coordinates workshop manufacturing, and schedules component safety checks.",
    skills: ["CAD/CAM", "Manufacturing Execution", "Chassis Stress Analysis", "Team Management"],
    projects: ["Suspension Mounting Refinement"],
    achievements: ["Led manufacturing process optimization for the VD team"],
    social: {
  ...
  makeMember({
    ...
    isCurrent: true,
    isLeadership: true,
    bio: "Coordinates microcontrollers coding, high-voltage battery enclosures, custom circuit integrations, and telemetry system stability.",
    skills: ["Embedded C", "Circuit Integration", "Microcontrollers", "RTOS"],
    social: {
  ...
  makeMember({
    ...
    isCurrent: true,
    isLeadership: true,
    bio: "Leads autonomous systems stack development, path planning algorithms, perception sensor fusion, and safety control loops.",
    skills: ["Python", "C++", "ROS2", "Computer Vision", "Deep Learning", "Motion Control"],
    projects: ["SAE Level-2 Autonomy Stack Deployments"],
    achievements: ["Engineered highly reliable autonomous lane tracking model"],
    social: {
